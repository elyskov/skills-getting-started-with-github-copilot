...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for league tournaments",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "alex@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Build teamwork and skills through soccer",
    ...
    "Robotics Club": {
        ...
        "max_participants": 16,
        "participants": ["connor@mergington.edu", "blake@mergington.edu", "tyler@mergington.edu"]
    },
    "Science Club": {
